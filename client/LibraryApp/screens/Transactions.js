...
const Transactions = ({navigation}) => {
  ...
  const booksReceived =
  useSelector(state => state.book.booksReceived) || [];
  const booksRequesting =
  useSelector(state => state.book.booksRequesting) || [];
  ...
  return (
    <View style={styles.container}>
      ...
      {type == 1 ? <BooksRequesting booksRequesting={booksRequesting}  navigation={navigation}/> : <BooksReceived booksReceived={booksReceived} navigation={navigation}/>}
    </View>
  );
};
